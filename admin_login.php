     ...
     <!--   <button type="button" class="toggle-btn" onclick="signup()">Sign Up</button> --> 
      ...
      <div class="social-icons">
       ...
       <form id="login" class="input-group" action="" method="post">
        ...
        <br><br><button type="submit" name="submit" class="submit-btn">Log In</button><br>
              ...
              while($row = mysqli_fetch_assoc($query_run)){
                ...
                if($row['email'] == $_POST['email']){
                  if($row['password'] == $_POST['password']){
                    header("Location: campus_dashboard.php");
                  }
                  else{
                    echo "Wrong Password";
                  }
      ...
      <form id="signup" class="input-group" action="" method="post">
        ...
        <input type="text" name="email" required class="input-field" placeholder="Email" required>
        <input type="text" name="password" required class="input-field" placeholder="Password" required>
        <input type="text" name="mobile" required class="input-field" placeholder="Mobile" required>
      ...
      <?php
          ...
          $connection = mysqli_connect('localhost','root','','mydb1','3308');
          $query = "insert into t7 values ('$_POST[email]','$_POST[password]','$_POST[mobile]')";
