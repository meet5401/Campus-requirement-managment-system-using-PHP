...
<body style="background-color:white">
	...
	<div id="left_side"><br><br>
		<form action="" method="post">
			<table>
				<tr>
					<td>
						 <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="show_companies" value="Show Companies">
					</td>
				</tr>
			</table>
		</form>
	...
	<div id="right_side"><br><br>
		...
		<?php
			...
			?>
			<center>
				<h3 style="color: white">Companie's Info:</h3><br><br>
				<table style="border-collapse: collapse;border:1px solid black ">
					<tr>
						<td id="id"><b>ID</b></td>
						<td id="id"><b>Name</b></td>
						<td id="id"><b>Email</b></td>
						<td id="id"><b>Required Field</b></td>
						<td id="id"><b>Job Location</b></td>
						<td id="id"><b>Experience</b></td>
						...
						<center>
							<table style="border-collapse:collapse;border:1px solid black ">
								<tr>
									...
									<td id="td"><?php echo $row['required_field'];?></td>
									<td id="td"><?php echo $row['job_location'];?></td>
									<td id="td"><?php echo $row['experience'];?></td>
								</tr>
							</table>
						</center>
						<?php
